...
let register_schema = Yup.object().shape({
    ...
    passwordconfirm: Yup.string().min(8,'Informe uma senha correta.').max(60,'Informe uma senha correta.').oneOf([Yup.ref('password'), null],'Os campos de senha não são iguais.').required('O Campo não foi inserido, digite e tente novamente.'),
